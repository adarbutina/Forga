...
class ComponentManager
{
     ...
     * @return string|bool
     */
    public function getComponentFilePath(string $componentName, string $fileName = 'index.php'): string | bool
    {
     ...
     */
    public function getComponentDirPath(string $componentName): string | bool
    {
     ...
     * @return string|boolean
     */
    public function get(string $componentName): string | bool
    {
