...
class TimberDynamicResize
{
     ...
     * @var array
     */
    public array $flyntResizedImages = [];
     ...
     * @return string
     */
    private function getDefaultRelativeUploadDir(): string
    {
     ...
     * @return string
     */
    public function getRelativeUploadDir(bool $useDefaultUploadDir = false): string
    {
     ...
     */
    public function resizeDynamic($src, float $w, float $h = 0, string $crop = 'default', bool $force = false): ?string
    {
        if (empty($src)) {
            return '';
        }
     ...
     */
    protected function generateImage(string $url, int $w, int $h, string $crop, bool $force = false): string
    {
