...
class Options
{
     ...
     * @var array
     */
    protected static array $optionPages = [];
     ...
     * @var array
     */
    protected static array $registeredOptions = [];
     ...
     */
    protected static function createOptionPage(string $optionType): array
    {
     ...
     * @throws Exception
     */
    protected static function createOptionSubPage(string $optionType, string $optionCategory = "Default"): void
    {
        if (empty(static::$optionPages[$optionType]['sub_pages'][$optionCategory])) {
            ...
            $fieldGroup = ACFComposer::forFieldGroup([
                'name' => $categorySlug,
                'title' => $categoryTitle,
                'style' => 'seamless',
                'fields' => [],
     ...
     * @return mixed
     */
    public static function getTranslatable(string $scope, ?string $fieldName = null): mixed
    {
     ...
     * @return mixed
     */
    public static function getGlobal(string $scope, ?string $fieldName = null): mixed
    {
     ...
     **/
    public static function get(string $optionType, string $scope, ?string $fieldName = null): mixed
    {
    ...
    /**
     * Add options to an options page.
     *
     * @param string $scope Scope of the option.
     * @param array $fields Fields to add.
     ...
     * @return array
     */
    protected static function registerOptionNames(string $type, string $scope, array $fields): array
    {
     ...
     * @throws Exception
     */
    protected static function addOptionsFieldGroup(string $name, string $title, string $optionsPageSlug, array $fields): void
    {
        $fieldGroup = ACFComposer::forFieldGroup(
            [
                'name' => $name,
     ...
     * @return mixed
     */
    protected static function getOptionField(string $key, bool $isTranslatable): mixed
    {
        if ($isTranslatable) {
     ...
     * @return string
     */
    public static function getDefaultAcfLanguage(): string
    {
