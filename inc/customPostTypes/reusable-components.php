...
add_action('init', function (): void {
    $labels = [
        ...
        'menu_name'             => __('Reusable Components', 'flynt'),
        'name_admin_bar'        => __('Reusable Components', 'flynt'),
        'archives'              => __('Reusable Components Archives', 'flynt'),
        'attributes'            => __('Reusable Components Attributes', 'flynt'),
        'parent_item_colon'     => __('Parent Reusable Components', 'flynt'),
