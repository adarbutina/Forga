 ...
 *
 * For a full list of parameters see https://developer.wordpress.org/reference/functions/register_post_type/
 * or use https://generatewp.com/post-type/ to generate the code for you.
 */
